      ...
      return Container(
        ...
        child: Column(
          children: [
            ...
            Text(
              'This memory is waiting for its first moment.',
            ...
            FilledButton.icon(
              ...
              onPressed: () =>
                  MultiMediaPickerScreen.open(context, memoryId: memory.id),
    ...
    return Scaffold(
      ...
      body: memoryAsync.when(
        ...
        error: (err, _) => ErrorState(
          ...
          onRetry: () => ref.invalidate(memoryDetailProvider(widget.memory.id)),
        ),
        data: (memory) {
          ...
          return CustomScrollView(
            ...
            slivers: [
                  ...
                  child: Row(
                    ...
                    children: [
                      _ActionButton(
                        ...
                        label: 'Add Media',
                        c: c,
                        onTap: () => MultiMediaPickerScreen.open(
                          context,
                          memoryId: memory.id,
                        ),
                      ),
              ...
              // Contextual Banner
              SliverToBoxAdapter(child: _buildContextualBanner(memory, c)),
                  ...
                  sliver: SliverToBoxAdapter(
                    child: Padding(
                      ...
                      child: EmptyState(
                        ...
                        title: 'No media yet.',
                        subtitle:
                            'Upload photos or videos to enrich this memory.',
                      ),
                    ),
                  ),
                ),
